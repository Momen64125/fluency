...
class SessionController extends ChangeNotifier {
  ...
  List<SessionEntity> sessions = [
    const SessionEntity(name: "Mohamed Halwani", date: "May 5, 2024, 16:00 PM", status: "Cancelled", duration: "15 min", group: 'Ongoing'),
    const SessionEntity(name: "Mohamed Halwani", date: "May 3, 2024, 16:00 PM", status: "Schedule", duration: "15 min", group: 'History'),
    const SessionEntity(name: "Mohamed Halwani", date: "May 1, 2024, 16:00 PM", status: "Ongoing", duration: "15 min", group: 'Ongoing'),
    const SessionEntity(name: "Mohamed Halwani ", date: "May 7, 2024, 16:00 PM", status: "Ongoing", duration: "15 min", group: 'History'),
    const SessionEntity(name: "Mohamed Halwani ", date: "May 7, 2024, 16:00 PM", status: "Done", duration: "15 min", group: 'Ongoing'),
    const SessionEntity(name: "Momen", date: "May 7, 2024, 16:00 PM", status: "Done", duration: "15 min", group: 'Ongoing'),
  ];
